            ...
            <li key={adjustment.id}>
              ...
              {adjustment.matchmakerId ? (
                <>
                  ...
                  <br />
                  {/* <FormGrid size={{ xs: 6 }}> */}
                <FormLabel htmlFor="statusAdjustment" required>
                    Status
                </FormLabel>
                <Select
                    id="statusAdjustment"
                    name="statusAdjustment"

                    value={adjustment.statusAdjustment}
                    onChange={(event)=>{handleInputChange(event, adjustment.id)}}  // פונקציה לעדכון הערך שנבחר
                    //onBlur={handleSave}
                    required
                    size="small"
                    displayEmpty
                >
                    <MenuItem value="" disabled>{adjustment.statusAdjustment}</MenuItem>
